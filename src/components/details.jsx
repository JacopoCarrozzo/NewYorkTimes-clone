...
import Footer from './footer'; // Modificato l'import del footer per non avere l'estensione .tsx
import backarrow from '../images/backarrow.png';

const Details = () => {
    const location = useLocation();
    const article = location.state?.data; // Rimosso l'optional chaining
        ...
        <>
            ...
            <div className="w-full sm:w-8/12 mx-auto p-4">
                ...
                <div className='sm:w-9/12 mx-auto text-center sm:text-left mt-6'>
                    <h1 className="font-bold text-2xl">{article ? article.title : "Titolo non disponibile"}</h1>
                </div>
